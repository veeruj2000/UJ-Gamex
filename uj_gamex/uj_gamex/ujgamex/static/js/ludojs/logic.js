...
var step_sound = new Audio('/static/ludoaudio/step.mp3');
var dead_sound = new Audio('/static/ludoaudio/dead.mp3');
var inout_sound = new Audio('/static/ludoaudio/inout.mp3');
var dice_sound = new Audio('/static/ludoaudio/dice.mp3');
var winner_sound = new Audio('/static/ludoaudio/winner.mp3');
        ...
        for (const item of run_point) {
            ...
            if (M_Player.path[M_Player.current_position] == 'win') {
                ...
                if (getWinPlayers(M_Player.home) > 3) {
                    ...
                    $(M_Player.home + " .white-box").css("background-image", "url(/static/img/ludoimg/crown" + rank_count + ".png)");
...
function activateDice() {
    $("#dice").css("opacity", "1");
    dice_value = 0;
    // $("#dice").css("background-image","url('/static/img/ludoimg/dice"+dice_value+".png')");
    $("#dice").html("<img src='/static/img/ludoimg/dice" + dice_value + ".png' class='dice'/>");
